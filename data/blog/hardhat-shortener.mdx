...
Are you tired of typing out `npx hardhat run --network ... scripts/....` every time you want to run a Hardhat command? I was too. That's why I wrote a simple bash script to shorten the command to `hh <optional network> <file>` and added an alias to my `.bashrc` (`.zshrc` for Mac users) file to make it even shorter.
